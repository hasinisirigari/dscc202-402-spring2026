...
dp.create_streaming_table(
    name="tweets_silver",
    comment="Cleaned and exploded tweet data with @mentions extracted, cleaned_text, and parsed timestamps. Row count exceeds bronze due to per-mention explosion."
)
