...
usa_franchises_df = (
    ...
    .filter(col("country") == "US")
)  # Load franchises and filter country == "USA"
...
enriched_transactions_df = (transactions_df
    .join( clean_customers_df , on="customerID", how="inner" )  # Join with clean_customers_df on "customerID"
    .join( usa_franchises_df , on="franchiseID", how="inner" )  # Join with usa_franchises_df on "franchiseID"
)
